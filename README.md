# #Knapsack: A Faster FPTAS, Formally Verified

This repository contains the paper **"A Faster FPTAS for #Knapsack"**
...
together with a **machine-checked implementation of its main algorithm in Lean 4**:
...
The paper: [`faster-fptas-knapsack.pdf`](faster-fptas-knapsack.pdf).
